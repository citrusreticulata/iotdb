...
public class AlterLogicalViewNode extends WritePlanNode implements ICreateLogicalViewPlan {
  ...
  public <R, C> R accept(PlanVisitor<R, C> visitor, C schemaRegion) {
    return visitor.visitAlterLogicalView(this, schemaRegion);
  }
  // endregion
  ...
  public PlanNode clone() {
    ...
    throw new NotImplementedException("Clone of AlterLogicalViewNode is not implemented");
  }
  ...
  public List<WritePlanNode> splitByPartition(Analysis analysis) {
    ...
    for (Map.Entry<TRegionReplicaSet, Map<PartialPath, ViewExpression>> entry :
      ...
      result.add(new AlterLogicalViewNode(getPlanNodeId(), entry.getValue(), entry.getKey()));
    }
    return result;
  }
  // endregion
